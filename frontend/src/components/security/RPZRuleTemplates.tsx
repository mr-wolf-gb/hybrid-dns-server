...
interface RPZRuleTemplatesProps {
  isOpen: boolean
  onClose: () => void
  onTemplateSelect?: (template: RPZRuleTemplate) => void
}

const RPZRuleTemplates: React.FC<RPZRuleTemplatesProps> = ({
  isOpen,
  onClose,
  onTemplateSelect,
}) => {
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2">
                  ...
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Add example domains that this template should handle
                  </p>
                </div>
              </div>
